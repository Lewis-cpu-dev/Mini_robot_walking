...
class MINI_Measured_ZMP: 
    ...
    def start(self):
        ...
        px = (right_zmp.point.x*self.right_force_z+ \
            left_zmp.point.x*self.left_force_z)/(self.right_force_z+self.left_force_z)
        py = (right_zmp.point.y*self.right_force_z+ \
            left_zmp.point.y*self.left_force_z)/(self.right_force_z+self.left_force_z)
        pz = -0.165
